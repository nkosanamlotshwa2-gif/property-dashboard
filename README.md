...
![Dashboard overview showing KPI hero strip, Strategy Quadrant, Action Required alerts and Node Performance grid](screenshots/dashboard.png)

### Strategy Quadrant — Yield vs Capital Growth
![Bubble chart plotting gross yield against capital gain percentage, colour-coded by investment node](screenshots/quadrant.png)

### Properties — Expandable Inventory
![Expandable property list with node filters, yield tags and inline financial detail drawers](screenshots/properties.png)

### Analytics Panel
![Analytics tab showing value vs purchase price bar chart, gross yield ranking and tenant profile mix](screenshots/analytics.png)

### Deeds & Costs — Acquisition Register
![Full acquisition register table with transfer costs, bond registration costs and deeds registration timelines](screenshots/deeds.png)

### AI Assistant
![AI Portfolio Intelligence chat panel with quick-ask prompts and portfolio analysis response](screenshots/ai.png)

### Scenario Simulator
![Scenario simulator panel with repo rate, vacancy, rental growth and capital value sliders](screenshots/simulator.png)
...
│   ├── quadrant.png              # Strategy Quadrant
│   ├── properties.png            # Expandable property inventory
│   ├── analytics.png             # Analytics panel
│   ├── deeds.png                 # Deeds & Costs register
│   ├── ai.png                    # AI Assistant
│   └── simulator.png             # Scenario Simulator
└── README.md
```
